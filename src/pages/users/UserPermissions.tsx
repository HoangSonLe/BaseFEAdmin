...
import { Typography, Card, Table, Button, Space, Input, Select, Checkbox, Form, Divider } from 'antd';
  ...
  const permissionGroups: PermissionGroup[] = [
    {
      module: 'Users',
      permissions: [
        { id: 'users:view', name: 'View Users', description: 'Can view user list and details', module: 'Users' },
    ...
    },
    {
      module: 'Products',
      permissions: [
        { id: 'products:view', name: 'View Products', description: 'Can view product list and details', module: 'Products' },
        { id: 'products:create', name: 'Create Products', description: 'Can create new products', module: 'Products' },
        { id: 'products:edit', name: 'Edit Products', description: 'Can edit existing products', module: 'Products' },
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: 'settings:edit', name: 'Edit Settings', description: 'Can modify system settings', module: 'Settings' },
      ]
    },
  ];
      ...
      permissionGroups.forEach(group => {
        group.permissions.forEach(permission => {
          if (permission.name.includes('View')) {
            values[permission.id] = true;
          } else if (permission.module === 'Products' && !permission.name.includes('Delete')) {
            values[permission.id] = true;
          } else {
