          ...
          <Col xs={24} sm={12} md={8} key={index}>
            <Card bordered={false} className="h-full">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-center w-12 h-12 rounded-full" style={{ backgroundColor: `${stat.color}20` }}>
                  <span style={{ color: stat.color, fontSize: '24px' }}>{stat.icon}</span>
                </div>
              </div>
              <div className="mt-4">
                <span className={stat.increase >= 0 ? 'text-green-500' : 'text-red-500'}>
